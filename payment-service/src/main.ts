...
const logger = new Logger('ServerMain-TicketService');
...
async function bootstrap() {
  ...
  await app.listen(portHTTP, () => {
    console.log(`PaymentService HTTP server is listening on port ${portHTTP}`);
  });
  //
  ...
  logger.log("PaymentService up and listening");
}
